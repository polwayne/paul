...
import de.paulwein.paul.database.ImportExportManager;
...
import de.paulwein.paul.fragments.NotesListFragment;

public class ShowNotesActivity extends FragmentActivity implements OnNavigationListener,IListDialogInterface{
	
	private NotesListFragmentAdapter mAdapter;
	...
	public void onCreate(Bundle savedInstanceState){
    	...
    	TextView tv_title = (TextView) findViewById(R.id.tv_notes_title);
	...
	private void initViewPager(){
    	...
    	mAdapter = new NotesListFragmentAdapter(getSupportFragmentManager());
   ...
   public boolean onOptionsItemSelected(MenuItem item) {
       ...
       case R.id.action_add_note:
    	  Intent noteIntent = new Intent(this,EditNotesActivity.class);
       ...
       case R.id.action_export:
	       	new Thread(new ImportExportManager(this)).start();
	       	return true;
       }
   ...
   public class NotesListFragmentAdapter extends FragmentPagerAdapter {
       public NotesListFragmentAdapter(android.support.v4.app.FragmentManager fm) {
           super(fm);
       }
       ...
       public android.support.v4.app.Fragment getItem(int position) {
    	   return NotesListFragment.newInstance(mCategorieIDs[position]);
       }
		...
		public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
			...
			case R.id.action_edit_list:
				 DialogFragment newFragment = AlertDialogListFragment.newInstance(
				            R.string.list_loeschen_dialog_text,ShowNotesActivity.this);
